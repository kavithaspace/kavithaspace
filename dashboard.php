        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
             ...
             <li>
              <a class="dropdown-item d-flex align-items-center" href="dashboard.php?logout='clicked'">
...
<!-- <?php echo $_SESSION["name_full"]; ?> -->
  </main><!-- End #main -->

  <!-- ======= Footer ======= -->
  <footer id="footer" class="footer  ">
    <div class="copyright">
      &copy; Copyright <strong><span>Kavitha</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
