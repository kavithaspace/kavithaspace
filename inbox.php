          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Mails REceived </h5>
<!-- PHP action started -->
...
<!-- PHP action ended -->
                  ...
                  <table class="table table-borderless datatable  ">
                    ...
                    <tbody>
                        ...
                        <?php
                         $sql="select * from email_sys where  status='income';";
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="trash.php?delete=<?php echo $row['id']; ?>"class="btn btn-danger">Delete</a>
